...
def sim(filename):
    ...
    p_sim_matrix = np.array([[0, 0.90822864, 0.008192], [0, 1, 0], [0, 0, 1]], dtype=np.float16)
    lms_img = np.tensordot(lms_img, p_sim_matrix, axes=([2], [1]))
    ...
    cv2.imwrite('static/sim/prot.png',colorblind_img)
    # cv2.waitKey(0)
